...
public class DTOStudentSubject {
    ...
    private DTOSubject StudentSubject;
    private DTOClass StudentClass;

    public DTOStudentSubject() {
    }

    public DTOStudentSubject(long ID, String Code, String Name, String Gender, String IdentityNumber, DTOSubject StudentSubject, DTOClass StudentClass) {
        this.ID = ID;
        this.Code = Code;
        this.Name = Name;
    ...
    /**
     * Get the value of StudentSubject
     *
     * @return the value of StudentSubject
     */
    public DTOSubject getStudentSubject() {
        return StudentSubject;
    }

    /**
     * Set the value of StudentSubject
     *
     * @param StudentSubject new value of StudentSubject
     */
    public void setStudentSubject(DTOSubject StudentSubject) {
        this.StudentSubject = StudentSubject;
    }
