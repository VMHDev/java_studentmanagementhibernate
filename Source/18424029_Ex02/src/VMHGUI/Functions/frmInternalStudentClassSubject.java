 ...
 * @author VMHIT
 */
public class frmInternalStudentClassSubject extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmInternalClass
     */
    public frmInternalStudentClassSubject() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlButtonLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnAdd, btnDelete, btnExit});
        ...
        pnlButtonLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnAdd, btnDelete, btnExit});
        ...
        lblInfoStudent.setText("Sinh viên theo Lớp - Môn học");
        ...
        txtStudentIdentityNumber.setEnabled(false);
        ...
        cboStudentGender.setEnabled(false);
        ...
        cboStudent.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cboClass, 0, 318, Short.MAX_VALUE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtStudentIdentityNumber, javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(cboStudentGender, javax.swing.GroupLayout.Alignment.CENTER, 0, 296, Short.MAX_VALUE)
    ...
    private void LoadDataToCombobox() {
        ...
        List<Studentdto> lstStudent = StudentDAO.GetAllStudent();
        lstStudent.add(0, null);
        ...
        cboStudentGender.addItem(new KeyValue("1", "Nam"));
        cboStudentGender.addItem(new KeyValue("0", "Nữ"));
    }

    private void LoadDataToTable() throws IOException {
        String[] colNames = new String[]{"ID", "MSSV", "Họ tên", "Giới tính", "CMND", "Lớp", "Môn học"};
        ...
        for (int i = 0; i < lstObj.size(); i++) {
            ...
            vecDataLine.add(0, Integer.toString(lstObj.get(i).getId().getStudentId().getId()));
            vecDataLine.add(1, lstObj.get(i).getId().getStudentId().getStudentCode());
            vecDataLine.add(2, lstObj.get(i).getId().getStudentId().getStudentName());
            Integer iGender = lstObj.get(i).getId().getStudentId().getGender();
            if (iGender == 1) {
                vecDataLine.add(3, "Nam");
            } else {
                vecDataLine.add(3, "Nữ");
            }
            vecDataLine.add(4, lstObj.get(i).getId().getStudentId().getIdentityNumber());
            ...
            vecDataLine.add(6, objSubject.getSubjectName());
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Transcriptdto objTranscript = new Transcriptdto(objTranscriptId);
        Integer rs = TranscriptDAO.AddTranscript(objTranscript);
        if (null == rs) {
            ...
            switch (rs) {
                case 1:
                    ...
                    break;
                case -1:
                    JOptionPane.showMessageDialog(null, "Đã tồn tại sinh viên trong lớp", "Lỗi", JOptionPane.WARNING_MESSAGE);
                    break;
                default:
                    JOptionPane.showMessageDialog(null, "Thêm sinh viên thất bại", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    break;
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (objTranscript != null) {
            objTranscript.setIsActive(false);
    ...
    private void tblStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStudentMouseClicked
        ...
        Integer idStudent = Integer.parseInt(txtStudentID.getText());
        clsUtilityCombobox.setSelectStudentWithID(cboStudent, idStudent);
        ...
        String codeClass = sourceTable.getModel().getValueAt(row, 5).toString();
        clsUtilityCombobox.setSelectClassWithCode(cboClass, codeClass);
        String nameSubject = sourceTable.getModel().getValueAt(row, 6).toString();
        clsUtilityCombobox.setSelectSubjectWithName(cboSubject, nameSubject);
    ...
    private void cboStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboStudentActionPerformed
        ...
        Studentdto modelStudent = (Studentdto) combo.getSelectedItem();
        txtStudentID.setText(Integer.toString(modelStudent.getId()));
        txtStudentCode.setText(modelStudent.getStudentCode());
        txtStudentIdentityNumber.setText(modelStudent.getIdentityNumber());
        Integer idClass = modelStudent.getClassId();
        clsUtilityCombobox.setSelectClassWithID(cboClass, idClass);
        String idGender = modelStudent.getGender().toString();
        clsUtilityCombobox.setSelectKeyValueWithID(cboStudentGender, idGender);
    ...
    private javax.swing.JComboBox<Object> cboStudentGender;
