 ...
 * @author VMHIT
 */
public class frmInternalQueryResultCheckExamination extends javax.swing.JInternalFrame {
     ...
     */
    public frmInternalQueryResultCheckExamination() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblInfoCheckExamination.setText("Tra cứu kết quả phúc khảo");
        ...
        txtScoresAfter.setEditable(false);
        ...
        pnlInfoLayout.setHorizontalGroup(
            ...
            .addGroup(pnlInfoLayout.createSequentialGroup()
                ...
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlInfoLayout.createSequentialGroup()
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cboSubject, 0, 190, Short.MAX_VALUE)
                            .addComponent(txtScoresWish, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cboClass, 0, 190, Short.MAX_VALUE)
                            .addComponent(txtScoresAfter, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                            .addComponent(txtScoresBefore, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                            .addComponent(txtStudentName, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)))
    ...
    public void LoadDefault() {
        try {
            ...
            Logger.getLogger(frmInternalQueryResultCheckExamination.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void LoadDataToTable() throws IOException {
        String[] colNames = new String[]{"Môn học", "Lớp", "Cột phúc khảo", "Điểm mong muốn", "Điểm sau", "Lý do", "Tình trạng", "ID Sinh viên", "ID Môn học", "ID Lớp"};
        DefaultTableModel modelObj = new DefaultTableModel(null, colNames);
        List<Checkexaminationdto> lstObj = CheckExaminationDAO.GetCheckExaminationWithStudent(objStudent);
        ...
        for (int i = 0; i < lstObj.size(); i++) {
            ...
            switch (sType) {
                case "M":
                    vecDataLine.add(2, "Giữa kỳ");
                    break;
                case "E":
                    vecDataLine.add(2, "Cuối kỳ");
                    break;
                case "O":
                    vecDataLine.add(2, "Khác");
                    break;
                case "S":
                    vecDataLine.add(2, "Tổng");
                    break;
                default:
                    vecDataLine.add(2, "");
                    break;
            }
            vecDataLine.add(3, Float.toString(lstObj.get(i).getScoresWish()));
            vecDataLine.add(4, Float.toString(lstObj.get(i).getScoresCheck()));
            vecDataLine.add(5, lstObj.get(i).getReason());
            char sStstus = lstObj.get(i).getStatusCheck();
            switch (sStstus) {
                case 'C':
                    vecDataLine.add(6, "Đã cập nhật");
                    break;
                case 'N':
                    vecDataLine.add(6, "Chưa cập nhật");
                    break;
                default:
                    vecDataLine.add(6, "Chưa xem");
                    break;
            }
            vecDataLine.add(7, Integer.toString(lstObj.get(i).getId().getStudentId().getId()));
            vecDataLine.add(8, Integer.toString(lstObj.get(i).getId().getSubjectId().getId()));
            vecDataLine.add(9, Integer.toString(lstObj.get(i).getId().getClassId().getId()));
    ...
    private void tblCheckMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCheckMouseClicked
        ...
        Integer subjectID = Integer.parseInt(sourceTable.getModel().getValueAt(row, 8).toString());
        clsUtilityCombobox.setSelectSubjectWithID(cboSubject, subjectID);
        Integer classID = Integer.parseInt(sourceTable.getModel().getValueAt(row, 9).toString());
        clsUtilityCombobox.setSelectClassWithID(cboClass, classID);

        String sType = sourceTable.getModel().getValueAt(row, 2).toString();
        clsUtilityCombobox.setSelectKeyValueWithValue(cboScoresType, sType);

        txtScoresWish.setText(sourceTable.getModel().getValueAt(row, 3).toString());
        txtScoresBefore.setText("");
        txtScoresAfter.setText(sourceTable.getModel().getValueAt(row, 4).toString());
        txtReason.setText(sourceTable.getModel().getValueAt(row, 5).toString());
        txtStatus.setText(sourceTable.getModel().getValueAt(row, 6).toString());
