 ...
 * @author VMHIT
 */
public class frmInternalQueryListCheckExamination extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmInternalClass
     */
    public frmInternalQueryListCheckExamination() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblStatusCheckLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnExit, btnSearch});
        ...
        lblInfoCheckExamination.setText("Tra cứu danh sách phúc khảo");
    ...
    public void LoadDefault() {
        try {
            ...
            Logger.getLogger(frmInternalQueryListCheckExamination.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void LoadDataToTable(Boolean _IsLoad) throws IOException {
        ...
        List<Checkexaminationdto> lstObj = CheckExaminationDAO.GetCheckExamination(modelClass, modelSubject, ' ');
